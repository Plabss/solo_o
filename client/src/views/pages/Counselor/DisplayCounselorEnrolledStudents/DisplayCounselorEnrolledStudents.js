...
const DisplayCounselorEnrolledStudents = ({enrolled}) => {
        ...
        <div>
            <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead className="text-nowrap">
                    ...
                    {
                        console.log("000000000",enrolled)
                    }
                </CTableHead>
                <CTableBody>
                    ...
                    {enrolled?.map((item, index) => {
                        return (
                            ...
                            <CTableRow v-for="item in tableItems" key={index} className='text-center'>
                                ...
                                <CTableDataCell>
                                    <Link to={`/counselor/student-details/${item.studentId}/${counselor.employee_id}`} state={{ item: item }}><button className="button">More Info</button></Link>
                                </CTableDataCell>
                            </CTableRow>
